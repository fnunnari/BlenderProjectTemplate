...
def BoolProperty(name="", description="", default=False, options={'ANIMATABLE'}, tags={}, subtype='NONE', update=None, get=None, set=None):
...
def BoolVectorProperty(name="", description="", default=(False, False, False), options={'ANIMATABLE'}, tags={}, subtype='NONE', size=3, update=None, get=None, set=None):
...
def CollectionProperty(type=None, name="", description="", options={'ANIMATABLE'}, tags={}):
...
def EnumProperty(items, name="", description="", default=None, options={'ANIMATABLE'}, tags={}, update=None, get=None, set=None):
...
def FloatProperty(name="", description="", default=0.0, min=-3.402823e+38, max=3.402823e+38, soft_min=-3.402823e+38, soft_max=3.402823e+38, step=3, precision=2, options={'ANIMATABLE'}, tags={}, subtype='NONE', unit='NONE', update=None, get=None, set=None):
...
def FloatVectorProperty(name="", description="", default=(0.0, 0.0, 0.0), min=sys.float_info.min, max=sys.float_info.max, soft_min=sys.float_info.min, soft_max=sys.float_info.max, step=3, precision=2, options={'ANIMATABLE'}, tags={}, subtype='NONE', unit='NONE', size=3, update=None, get=None, set=None):
...
def IntProperty(name="", description="", default=0, min=-2**31, max=2**31-1, soft_min=-2**31, soft_max=2**31-1, step=1, options={'ANIMATABLE'}, tags={}, subtype='NONE', update=None, get=None, set=None):
...
def IntVectorProperty(name="", description="", default=(0, 0, 0), min=-2**31, max=2**31-1, soft_min=-2**31, soft_max=2**31-1, step=1, options={'ANIMATABLE'}, tags={}, subtype='NONE', size=3, update=None, get=None, set=None):
...
def PointerProperty(type=None, name="", description="", options={'ANIMATABLE'}, tags={}, poll=None, update=None):
...
def StringProperty(name="", description="", default="", maxlen=0, options={'ANIMATABLE'}, tags={}, subtype='NONE', update=None, get=None, set=None):
